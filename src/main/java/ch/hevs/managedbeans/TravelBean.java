...
public class TravelBean
{
    ...
    public String newPassenger() {
   	
		return "createPassenger"; //  the String value returned represents the outcome used by the navigation handler to determine what page to display next.
	}
